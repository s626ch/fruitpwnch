...
let scamExamples = ['Discord Nitro for Free - Steam Store', 'Discord nitro distribution', 'Discord Nitro for Free', ' https://dlscordgived.xyz/', 'https://discord-app.net/', 'BTC charity draw', 'You are one of the lucky winners of our giveaway', 'Crypto Discord Channels', 'Giveaway News! Congratulations!', 'Free distribution of discord nitro', 'best pump signals', 'the right strategies for making money', 'she made ur dick hard... join back', 'Hi bro, i made game can you rate pls', 'Hi bro, you can rate my game pls', 'https://hypesquad-selections.com/', 'I lost about a hundred of dollars via credit card', 'Sorry to bother you is this your steam account?', 'reported you for doing illegal purchasing', 'someone who had the same steam profile and name', 'https://dscordapb-glft.com/', 'from steam nitro', 'https://cdn.discordapp.com/attachments/963621520167563287/975898842815950848/Snake_IT_Project.zip', 'Snake_IT_Project.zip', 'so i am in this it class and we had to make a simple game like ping pong', 'we are starting the HypeSquad Events Program again!', 'https://registers-to-hypeteams.com/', 'play.mineshards.net', 'https://events-squad.com/', 'https://morytrade.com/', 'MORYTRADE', 'https://dicord-premium.ru', 'freesteamnitro', 'Discord Nitro free from STEAM', 'https://roblox-app.com/', 'https://dominio.com/', 'you got SELECTED for our HypeSquad Program', 'https://registration-for-hypesquad.com', 'https://badge-events.gq/'];
...
// create the button, could lessen this by one line, but i really don't want to touch what works.
// oh also the image is a data uri because lmao discord's content security policy is so god awful!
let pwnchIcon
pwnchIcon = createElm(`<div id="pwnchButton" role="button">
...
// there was going to be a light/dark theme check but i'm not using it anymore, however i'm keeping the snippet
